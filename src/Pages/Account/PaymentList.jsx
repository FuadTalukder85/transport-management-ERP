          ...
          <table className="w-full text-sm text-left">
            <thead className="text-black capitalize font-bold">
              <tr>
                ...
                <th className="border border-gray-700 px-2 py-3">Category</th>
                <th className="border border-gray-700 px-2 py-3">Quantity</th>
                <th className="border border-gray-700 px-2 py-3">UnitPrice</th>
                <th className="border border-gray-700 px-2 py-3">
                  TotalAmount
                </th>
                <th className="border border-gray-700 px-2 py-3">CashIn</th>
                <th className="border border-gray-700 px-2 py-3">MainAmount</th>
                <th className="border border-gray-700 px-2 py-3">Remarks</th>

                <th className="border border-gray-700 px-2 py-3">BranchName</th>
                <th className="border border-gray-700 px-2 py-3">CreatedBy</th>
            ...
            <tbody className="text-black font-semibold">
              <tr className="hover:bg-gray-50 transition-all">
                ...
                <td className="border border-gray-700 px-2 py-4">2</td>
                <td className="border border-gray-700 px-2 py-4">2000</td>
                <td className="border border-gray-700 px-2 py-4">4000</td>
                <td className="border border-gray-700 px-2 py-4">5000</td>
                <td className="border border-gray-700 px-2 py-4">6000</td>
                <td className="border border-gray-700 px-2 py-4">N/A</td>
                <td className="border border-gray-700 px-2 py-4">Dhaka</td>
                <td className="border border-gray-700 px-2 py-4">Motin</td>
