...
const DriverLedger = () => {
  ...
  return (
    <div className="overflow-x-auto p-4 bg-gradient-to-br from-gray-100 to-white md:p-2">
      {/* Header */}
      ...
      {/* Table */}
      <div className="bg-white/80 backdrop-blur-md shadow-xl rounded-xl p-2 py-10 border border-gray-200">
        <table className="table-auto border-collapse border border-black w-full text-center text-sm">
          <thead>
            <tr>
          ...
          <tbody>
            {filteredDriver.map((item, index) => {
              ...
              // First row: use openingBalance
              const balance = previousBalance + Number(advanced) - totalExpense;
