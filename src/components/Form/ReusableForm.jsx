  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div className="flex justify-center mt-10">
        <button
          type="submit"
          className="w-full font-semibold uppercase text-sm bg-primary text-white px-16 py-2 rounded hover:bg-secondary cursor-pointer transition-all duration-700"
        >
          Login
        </button>
      </div>
