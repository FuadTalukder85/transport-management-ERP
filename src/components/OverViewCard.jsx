...
const OverViewCard = () => {
    ...
    const fetchDispatch = async () => {
      try {
        const response = await axios.get(
          "https://api.tramessy.com/mstrading/api/account/list"
        );
        const data = response.data?.data || [];
        const total = data
          .filter((item) => item.date === today)
  ...
  useEffect(() => {
    const fetchAmount = async () => {
      try {
        const response = await axios.get(
          "https://api.tramessy.com/mstrading/api/paymentRecived/list"
        );
        const data = response.data?.data || [];
        const total = data
          .filter((item) => item.date === today)
    ...
    <div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div className="bg-white rounded-xl shadow-md p-5 border border-gray-200 cursor-pointer">
          <h3 className="text-lg font-bold text-secondary border-b border-gray-200 pb-2 mb-4">
            Daily Trip
          </h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 pt-5">
        ...
        <div className="col-span-2 bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-lg p-6 border border-gray-200">
          <h3 className="text-xl font-bold text-secondary border-b border-gray-300 pb-3 mb-4">
          ...
          <div className="text-sm text-gray-700">
            ...
            <div className="grid grid-cols-5 gap-3 py-2 px-3 items-center hover:bg-gray-50 transition">
              <div className="font-medium text-secondary">Trip Cost</div>
            ...
            <div className="border-t border-gray-200 pt-2 space-y-2">
              ...
              <div className="flex justify-between font-bold text-base text-secondary border-t border-dashed border-gray-300 pt-3 mt-2">
