...
const MonthlyCustomerPieChart = () => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md px-5 mr-5 border border-gray-200 cursor-pointer">
      <h3 className="text-lg font-bold text-primary text-center border-b md:p-3 pb-2">
